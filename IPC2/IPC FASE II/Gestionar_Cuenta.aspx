<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Gestionar_Cuenta.aspx.cs" Inherits="Gestionar_Cuenta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <div class="formulario">
                    ...
                    <asp:TextBox CssClass="introducir" ID="usuario_re" runat="server" placeholder="Usuario" ReadOnly="True"></asp:TextBox>
                    ...
                    <asp:button id="botontregis" runat="server" Text="Guardar Cambios" CssClass="botones" BackColor="#4CAF50" OnClick="botontregis_Click"></asp:button>
                </div>
            </div> 
    </div>
        </div>
