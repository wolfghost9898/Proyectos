<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MyRetro.aspx.cs" Inherits="MyRetro" %>
...
<asp:TemplateField>
    <ItemTemplate>
        <asp:LinkButton ID="lnkRemove" runat="server"
            CommandArgument = '<%# Eval("id_retroalimentacion")%>'
         OnClientClick = "return confirm('¿Seguro que quieres eliminar esta Retroalimentacion?')"
...
<asp:TemplateField>
    <ItemTemplate>
        <asp:LinkButton ID="lnkEdit" runat="server"
            CommandArgument = '<%# Eval("id_retroalimentacion")%>'
         OnClientClick = "return confirm('¿Seguro que desea Editar esta Retroalimentacion?')"
        Text = "Editar" OnClick = "EditCustomer"></asp:LinkButton>
    </ItemTemplate>
